...
/* Helper routines */
static herr_t H5VL_intent_file_specific_reissue(void *obj, hid_t connector_id, H5VL_file_specific_args_t *args,
                                                hid_t dxpl_id, void **req);

static herr_t H5VL_intent_request_specific_reissue(void *obj, hid_t connector_id,
                                                   H5VL_request_specific_args_t *args);

static herr_t H5VL_intent_link_create_reissue(H5VL_link_create_args_t *args, void *obj,
...
static herr_t H5VL_intent_info_cmp(int *cmp_value, const void *info1, const void *info2);
...
static void *H5VL_intent_wrap_object(void *obj, H5I_type_t obj_type, void *wrap_ctx);
...
/* Attribute callbacks */
static void *H5VL_intent_attr_create(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
                                     hid_t type_id, hid_t space_id, hid_t acpl_id, hid_t aapl_id,
                                     hid_t dxpl_id, void **req);

static void *H5VL_intent_attr_open(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
                                   hid_t aapl_id, hid_t dxpl_id, void **req);

static herr_t H5VL_intent_attr_read(void *attr, hid_t mem_type_id, void *buf, hid_t dxpl_id,
                                    void **req);

static herr_t H5VL_intent_attr_write(void *attr, hid_t mem_type_id, const void *buf, hid_t dxpl_id,
                                     void **req);

static herr_t H5VL_intent_attr_get(void *obj, H5VL_attr_get_args_t *args, hid_t dxpl_id, void **req);

static herr_t H5VL_intent_attr_specific(void *obj, const H5VL_loc_params_t *loc_params,
                                        H5VL_attr_specific_args_t *args, hid_t dxpl_id, void **req);

static herr_t H5VL_intent_attr_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id,
                                        void **req);

static herr_t H5VL_intent_attr_close(void *attr, hid_t dxpl_id, void **req);

/* Dataset callbacks */
static void *H5VL_intent_dataset_create(void *obj, const H5VL_loc_params_t *loc_params,
                                        const char *name, hid_t lcpl_id, hid_t type_id, hid_t space_id,
                                        hid_t dcpl_id, hid_t dapl_id, hid_t dxpl_id, void **req);

static void *H5VL_intent_dataset_open(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
                                      hid_t dapl_id, hid_t dxpl_id, void **req);

static herr_t H5VL_intent_dataset_read(void *dset, hid_t mem_type_id, hid_t mem_space_id,
                                       hid_t file_space_id, hid_t plist_id, void *buf, void **req);

static herr_t H5VL_intent_dataset_write(void *dset, hid_t mem_type_id, hid_t mem_space_id,
                                        hid_t file_space_id, hid_t plist_id, const void *buf,
                                        void **req);

static herr_t H5VL_intent_dataset_get(void *dset, H5VL_dataset_get_args_t *args, hid_t dxpl_id,
                                      void **req);

static herr_t H5VL_intent_dataset_specific(void *obj, H5VL_dataset_specific_args_t *args,
                                           hid_t dxpl_id, void **req);

static herr_t H5VL_intent_dataset_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id,
                                           void **req);

static herr_t H5VL_intent_dataset_close(void *dset, hid_t dxpl_id, void **req);

/* Datatype callbacks */
static void *H5VL_intent_datatype_commit(void *obj, const H5VL_loc_params_t *loc_params,
                                         const char *name, hid_t type_id, hid_t lcpl_id, hid_t tcpl_id,
                                         hid_t tapl_id, hid_t dxpl_id, void **req);

static void *H5VL_intent_datatype_open(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
                                       hid_t tapl_id, hid_t dxpl_id, void **req);

static herr_t H5VL_intent_datatype_get(void *dt, H5VL_datatype_get_args_t *args, hid_t dxpl_id,
                                       void **req);

static herr_t H5VL_intent_datatype_specific(void *obj, H5VL_datatype_specific_args_t *args,
                                            hid_t dxpl_id, void **req);

static herr_t H5VL_intent_datatype_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id,
                                            void **req);

static herr_t H5VL_intent_datatype_close(void *dt, hid_t dxpl_id, void **req);

/* File callbacks */
static void *H5VL_intent_file_create(const char *name, unsigned flags, hid_t fcpl_id, hid_t fapl_id,
                                     hid_t dxpl_id, void **req);

static void *H5VL_intent_file_open(const char *name, unsigned flags, hid_t fapl_id, hid_t dxpl_id,
                                   void **req);

static herr_t H5VL_intent_file_get(void *file, H5VL_file_get_args_t *args, hid_t dxpl_id, void **req);

static herr_t H5VL_intent_file_specific(void *file, H5VL_file_specific_args_t *args, hid_t dxpl_id,
                                        void **req);

static herr_t H5VL_intent_file_optional(void *file, H5VL_optional_args_t *args, hid_t dxpl_id,
                                        void **req);

static herr_t H5VL_intent_file_close(void *file, hid_t dxpl_id, void **req);

/* Group callbacks */
static void *H5VL_intent_group_create(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
                                      hid_t lcpl_id, hid_t gcpl_id, hid_t gapl_id, hid_t dxpl_id,
                                      void **req);

static void *H5VL_intent_group_open(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
                                    hid_t gapl_id, hid_t dxpl_id, void **req);

static herr_t H5VL_intent_group_get(void *obj, H5VL_group_get_args_t *args, hid_t dxpl_id, void **req);

static herr_t H5VL_intent_group_specific(void *obj, H5VL_group_specific_args_t *args, hid_t dxpl_id,
                                         void **req);

static herr_t H5VL_intent_group_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id,
                                         void **req);
...
static herr_t H5VL_intent_link_copy(void *src_obj, const H5VL_loc_params_t *loc_params1, void *dst_obj,
                                    const H5VL_loc_params_t *loc_params2, hid_t lcpl_id, hid_t lapl_id,
                                    hid_t dxpl_id, void **req);

static herr_t H5VL_intent_link_move(void *src_obj, const H5VL_loc_params_t *loc_params1, void *dst_obj,
                                    const H5VL_loc_params_t *loc_params2, hid_t lcpl_id, hid_t lapl_id,
                                    hid_t dxpl_id, void **req);

static herr_t H5VL_intent_link_get(void *obj, const H5VL_loc_params_t *loc_params,
                                   H5VL_link_get_args_t *args, hid_t dxpl_id, void **req);

static herr_t H5VL_intent_link_specific(void *obj, const H5VL_loc_params_t *loc_params,
                                        H5VL_link_specific_args_t *args, hid_t dxpl_id, void **req);

static herr_t
H5VL_intent_link_optional(void *obj, const H5VL_loc_params_t *loc_params, H5VL_optional_args_t *args, hid_t dxpl_id,
                          void **req);

/* Object callbacks */
static void *H5VL_intent_object_open(void *obj, const H5VL_loc_params_t *loc_params,
                                     H5I_type_t *opened_type, hid_t dxpl_id, void **req);

static herr_t H5VL_intent_object_copy(void *src_obj, const H5VL_loc_params_t *src_loc_params,
                                      const char *src_name, void *dst_obj,
                                      const H5VL_loc_params_t *dst_loc_params, const char *dst_name,
                                      hid_t ocpypl_id, hid_t lcpl_id, hid_t dxpl_id, void **req);

static herr_t H5VL_intent_object_get(void *obj, const H5VL_loc_params_t *loc_params,
                                     H5VL_object_get_args_t *args, hid_t dxpl_id, void **req);

static herr_t H5VL_intent_object_specific(void *obj, const H5VL_loc_params_t *loc_params,
                                          H5VL_object_specific_args_t *args, hid_t dxpl_id,
                                          void **req);

static herr_t
H5VL_intent_object_optional(void *obj, const H5VL_loc_params_t *loc_params, H5VL_optional_args_t *args, hid_t dxpl_id,
                            void **req);

/* Container/connector introspection callbacks */
static herr_t H5VL_intent_introspect_get_conn_cls(void *obj, H5VL_get_conn_lvl_t lvl,
                                                  const H5VL_class_t **conn_cls);
#if H5_VERSION_GE(1, 13, 3)
static herr_t H5VL_intent_introspect_get_cap_flags(const void *info, uint64_t *cap_flags);
#else
static herr_t H5VL_intent_introspect_get_cap_flags(const void *info, unsigned *cap_flags);
#endif
static herr_t H5VL_intent_introspect_opt_query(void *obj, H5VL_subclass_t cls, int opt_type,
                                               uint64_t *flags);

/* Async request callbacks */
static herr_t H5VL_intent_request_wait(void *req, uint64_t timeout, H5VL_request_status_t *status);

static herr_t H5VL_intent_request_notify(void *obj, H5VL_request_notify_t cb, void *ctx);

static herr_t H5VL_intent_request_cancel(void *req, H5VL_request_status_t *status);

static herr_t H5VL_intent_request_specific(void *req, H5VL_request_specific_args_t *args);

static herr_t H5VL_intent_request_optional(void *req, H5VL_optional_args_t *args);

static herr_t H5VL_intent_request_free(void *req);

/* Blob callbacks */
static herr_t H5VL_intent_blob_put(void *obj, const void *buf, size_t size, void *blob_id, void *ctx);

static herr_t H5VL_intent_blob_get(void *obj, const void *blob_id, void *buf, size_t size, void *ctx);

static herr_t H5VL_intent_blob_specific(void *obj, void *blob_id, H5VL_blob_specific_args_t *args);

static herr_t H5VL_intent_blob_optional(void *obj, void *blob_id, H5VL_optional_args_t *args);

/* Token callbacks */
static herr_t H5VL_intent_token_cmp(void *obj, const H5O_token_t *token1, const H5O_token_t *token2,
                                    int *cmp_value);

static herr_t H5VL_intent_token_to_str(void *obj, H5I_type_t obj_type, const H5O_token_t *token,
                                       char **token_str);

static herr_t H5VL_intent_token_from_str(void *obj, H5I_type_t obj_type, const char *token_str,
                                         H5O_token_t *token);

/* Generic optional callback */
static herr_t H5VL_intent_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id, void **req);
 ...
 *-------------------------------------------------------------------------
 */
static H5VL_intent_t *
H5VL_intent_new_obj(void *under_obj, hid_t under_vol_id) {
 ...
 */
static herr_t
H5VL_intent_free_obj(H5VL_intent_t *obj) {
    hid_t err_id;
 ...
 */
static herr_t
H5VL_intent_init(hid_t vipl_id) {
 ...
 */
static void *
H5VL_intent_info_copy(const void *_info) {
 ...
 */
static herr_t
H5VL_intent_info_cmp(int *cmp_value, const void *_info1, const void *_info2) {
 ...
 */
static herr_t
H5VL_intent_info_free(void *_info) {
 ...
 */
static herr_t
H5VL_intent_info_to_str(const void *_info, char **str) {
    const H5VL_intent_info_t *info = (const H5VL_intent_info_t *) _info;
 ...
 */
static herr_t
H5VL_intent_str_to_info(const char *str, void **_info) {
 ...
 */
static void *
H5VL_intent_get_object(const void *obj) {
 ...
 */
static herr_t
H5VL_intent_get_wrap_ctx(const void *obj, void **wrap_ctx) {
    const H5VL_intent_t *o = (const H5VL_intent_t *) obj;
...
/* Allocate new VOL object wrapping context for the intent connector */
    new_wrap_ctx = (H5VL_intent_wrap_ctx_t *) calloc(1, sizeof(H5VL_intent_wrap_ctx_t));
 ...
 */
static void *
H5VL_intent_wrap_object(void *obj, H5I_type_t obj_type, void *_wrap_ctx) {
 ...
 */
static void *
H5VL_intent_unwrap_object(void *obj) {
 ...
 */
static herr_t
H5VL_intent_free_wrap_ctx(void *_wrap_ctx) {
    H5VL_intent_wrap_ctx_t *wrap_ctx = (H5VL_intent_wrap_ctx_t *) _wrap_ctx;
    hid_t err_id;
 ...
 */
static void *
H5VL_intent_attr_create(void *obj, const H5VL_loc_params_t *loc_params, const char *name, hid_t type_id,
...
/* Check for async request */
        if (req && *req)
            *req = H5VL_intent_new_obj(*req, o->under_vol_id);
    } /* end if */
    else
        attr = NULL;
 ...
 */
static void *
H5VL_intent_attr_open(void *obj, const H5VL_loc_params_t *loc_params, const char *name, hid_t aapl_id,
                      hid_t dxpl_id, void **req) {
    H5VL_intent_t *attr;
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    void *under;
 ...
 */
static herr_t
H5VL_intent_attr_read(void *attr, hid_t mem_type_id, void *buf, hid_t dxpl_id, void **req) {
 ...
 */
static herr_t
H5VL_intent_attr_write(void *attr, hid_t mem_type_id, const void *buf, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) attr;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_attr_get(void *obj, H5VL_attr_get_args_t *args, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_attr_specific(void *obj, const H5VL_loc_params_t *loc_params,
                          H5VL_attr_specific_args_t *args, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_attr_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_attr_close(void *attr, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) attr;
    herr_t ret_value;
 ...
 */
static void *
H5VL_intent_dataset_create(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
 ...
 */
static void *
H5VL_intent_dataset_open(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
                         hid_t dapl_id, hid_t dxpl_id, void **req) {
    H5VL_intent_t *dset;
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    void *under;
 ...
 */
static herr_t
H5VL_intent_dataset_read(void *dset, hid_t mem_type_id, hid_t mem_space_id, hid_t file_space_id,
 ...
 */
static herr_t
H5VL_intent_dataset_write(void *dset, hid_t mem_type_id, hid_t mem_space_id, hid_t file_space_id,
 ...
 */
static herr_t
H5VL_intent_dataset_get(void *dset, H5VL_dataset_get_args_t *args, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) dset;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_dataset_specific(void *obj, H5VL_dataset_specific_args_t *args, hid_t dxpl_id,
                             void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    hid_t under_vol_id;
    herr_t ret_value;
...
// refresh destroying the current object
    ...
    ret_value =
            H5VLdataset_specific(o->under_object, o->under_vol_id, args, dxpl_id, req);

/* Check for async request */
    if (req && *req)
        *req = H5VL_intent_new_obj(*req, under_vol_id);
 ...
 */
static herr_t
H5VL_intent_dataset_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_dataset_close(void *dset, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) dset;
    herr_t ret_value;
 ...
 */
static void *
H5VL_intent_datatype_commit(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
 ...
 */
static void *
H5VL_intent_datatype_open(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
                          hid_t tapl_id, hid_t dxpl_id, void **req) {
    H5VL_intent_t *dt;
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    void *under;
 ...
 */
static herr_t
H5VL_intent_datatype_get(void *dt, H5VL_datatype_get_args_t *args, hid_t dxpl_id, void **req) {
 ...
 */
static herr_t
H5VL_intent_datatype_specific(void *obj, H5VL_datatype_specific_args_t *args, hid_t dxpl_id,
                              void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    hid_t under_vol_id;
    herr_t ret_value;
...
// refresh destroying the current object
    ...
    ret_value =
            H5VLdatatype_specific(o->under_object, o->under_vol_id, args, dxpl_id, req);
 ...
 */
static herr_t
H5VL_intent_datatype_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_datatype_close(void *dt, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) dt;
    herr_t ret_value;
 ...
 */
static void *
H5VL_intent_file_create(const char *name, unsigned flags, hid_t fcpl_id, hid_t fapl_id, hid_t dxpl_id,
                        void **req) {
    H5VL_intent_info_t *info;
    H5VL_intent_t *file;
    hid_t under_fapl_id;
...
/* Check for async request */
        if (req && *req)
            *req = H5VL_intent_new_obj(*req, info->under_vol_id);
    } /* end if */
    else
        file = NULL;
 ...
 */
static void *
H5VL_intent_file_open(const char *name, unsigned flags, hid_t fapl_id, hid_t dxpl_id, void **req) {
    H5VL_intent_info_t *info;
    H5VL_intent_t *file;
    hid_t under_fapl_id;
    void *under;
 ...
 */
static herr_t
H5VL_intent_file_get(void *file, H5VL_file_get_args_t *args, hid_t dxpl_id, void **req) {
 ...
 */
static herr_t
H5VL_intent_file_specific_reissue(void *obj, hid_t connector_id, H5VL_file_specific_args_t *args,
                                  hid_t dxpl_id, void **req) {
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_file_specific(void *file, H5VL_file_specific_args_t *args, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) file;
 ...
 */
static herr_t
H5VL_intent_file_optional(void *file, H5VL_optional_args_t *args, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) file;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_file_close(void *file, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) file;
    herr_t ret_value;
 ...
 */
static void *
H5VL_intent_group_create(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
 ...
 */
static void *
H5VL_intent_group_open(void *obj, const H5VL_loc_params_t *loc_params, const char *name, hid_t gapl_id,
                       hid_t dxpl_id, void **req) {
    H5VL_intent_t *group;
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    void *under;
 ...
 */
static herr_t
H5VL_intent_group_get(void *obj, H5VL_group_get_args_t *args, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_group_specific(void *obj, H5VL_group_specific_args_t *args, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    hid_t under_vol_id;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_group_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_group_close(void *grp, hid_t dxpl_id, void **req) {
 ...
 */
static herr_t
H5VL_intent_link_create_reissue(H5VL_link_create_args_t *args, void *obj,
                                const H5VL_loc_params_t *loc_params, hid_t connector_id, hid_t lcpl_id,
                                hid_t lapl_id, hid_t dxpl_id, void **req) {

    herr_t ret_value;
    ret_value = H5VLlink_create(args, obj, loc_params, connector_id, lcpl_id, lapl_id, dxpl_id, req);
    return ret_value;
 ...
 */
static herr_t
H5VL_intent_link_create(H5VL_link_create_args_t *args, void *obj,
                        const H5VL_loc_params_t *loc_params, hid_t lcpl_id, hid_t lapl_id,
                        hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    hid_t under_vol_id = -1;
    herr_t ret_value;
    ret_value = H5VLlink_create(args, (o ? o->under_object : NULL), loc_params, under_vol_id,
 ...
 */
static herr_t
H5VL_intent_link_copy(void *src_obj, const H5VL_loc_params_t *loc_params1, void *dst_obj,
 ...
 */
static herr_t
H5VL_intent_link_move(void *src_obj, const H5VL_loc_params_t *loc_params1, void *dst_obj,
                      const H5VL_loc_params_t *loc_params2, hid_t lcpl_id, hid_t lapl_id, hid_t dxpl_id,
                      void **req) {
    H5VL_intent_t *o_src = (H5VL_intent_t *) src_obj;
    H5VL_intent_t *o_dst = (H5VL_intent_t *) dst_obj;
 ...
 */
static herr_t
H5VL_intent_link_get(void *obj, const H5VL_loc_params_t *loc_params, H5VL_link_get_args_t *args,
                     hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_link_specific(void *obj, const H5VL_loc_params_t *loc_params,
                          H5VL_link_specific_args_t *args, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static void *
H5VL_intent_object_open(void *obj, const H5VL_loc_params_t *loc_params, H5I_type_t *opened_type,
                        hid_t dxpl_id, void **req) {
    H5VL_intent_t *new_obj;
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    void *under;
 ...
 */
static herr_t
H5VL_intent_object_copy(void *src_obj, const H5VL_loc_params_t *src_loc_params, const char *src_name,
...
/* Check for async request */
    if (req && *req)
        *req = H5VL_intent_new_obj(*req, o_src->under_vol_id);
 ...
 */
static herr_t
H5VL_intent_object_get(void *obj, const H5VL_loc_params_t *loc_params, H5VL_object_get_args_t *args,
                       hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_object_specific(void *obj, const H5VL_loc_params_t *loc_params,
 ...
 */
herr_t
H5VL_intent_introspect_get_conn_cls(void *obj, H5VL_get_conn_lvl_t lvl, const H5VL_class_t **conn_cls) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
...
#endif
{
    ...
    if (ret_value >= 0)
        *cap_flags |= H5VL_intent_g.cap_flags;
 ...
 */
herr_t
H5VL_intent_introspect_opt_query(void *obj, H5VL_subclass_t cls, int opt_type, uint64_t *flags) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_request_wait(void *obj, uint64_t timeout, H5VL_request_status_t *status) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_request_notify(void *obj, H5VL_request_notify_t cb, void *ctx) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_request_cancel(void *obj, H5VL_request_status_t *status) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_request_specific_reissue(void *obj, hid_t connector_id,
                                     H5VL_request_specific_args_t *args) {
 ...
 */
static herr_t
H5VL_intent_request_specific(void *obj, H5VL_request_specific_args_t *args) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_request_optional(void *obj, H5VL_optional_args_t *args) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_request_free(void *obj) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
herr_t
H5VL_intent_blob_put(void *obj, const void *buf, size_t size, void *blob_id, void *ctx) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
herr_t
H5VL_intent_blob_get(void *obj, const void *blob_id, void *buf, size_t size, void *ctx) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
herr_t
H5VL_intent_blob_specific(void *obj, void *blob_id, H5VL_blob_specific_args_t *args) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
herr_t
H5VL_intent_blob_optional(void *obj, void *blob_id, H5VL_optional_args_t *args) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_token_cmp(void *obj, const H5O_token_t *token1, const H5O_token_t *token2, int *cmp_value) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_token_to_str(void *obj, H5I_type_t obj_type, const H5O_token_t *token, char **token_str) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_intent_token_from_str(void *obj, H5I_type_t obj_type, const char *token_str, H5O_token_t *token) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
 ...
 */
herr_t
H5VL_intent_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id, void **req) {
    H5VL_intent_t *o = (H5VL_intent_t *) obj;
    herr_t ret_value;
